		...
		struct page *newpage, struct page *page, enum migrate_mode mode)
{
	...
	vb->num_pfns = VIRTIO_BALLOON_PAGES_PER_PAGE;
	printk(KERN_INFO "MY DEBUG. num_pfns before: %u\n", vb->num_pfns);
	...
	spin_unlock_irqrestore(&vb_dev_info->pages_lock, flags);
	vb->num_pfns = VIRTIO_BALLOON_PAGES_PER_PAGE;
	printk(KERN_INFO "MY DEBUG. num_pfns AFTER: %u\n", vb->num_pfns);
...
static struct virtio_driver virtio_balloon_driver_original = {
...
module_virtio_driver(virtio_balloon_driver_original);
MODULE_DEVICE_TABLE(virtio, id_table);
MODULE_DESCRIPTION("Virtio balloon driver. Original");
MODULE_LICENSE("GPL");
